    ...
    window.history && window.history.pushState && $(window).on("popstate", function() {
        var t = window.location.href; - 1 == t.indexOf("#") && (r.addClass("spa-loader"), $.ajax({
            ...
            success: function(t, o, e) {
                r.removeClass("spa-loader"), r.html(t), a=1,a=2
            },
        ...
        (n = null == n ? r : $(n)).addClass("spa-loader"), "post" == o.toLowerCase() ? $.ajax({
            ...
            contentType: !1,
            success: function(t, o, e) {
                n.removeClass("spa-loader"), null != l.attr("eval") || (n == r && (a = e.getResponseHeader("Location")) != window.location.href.toString().split(window.location.host)[1] && window.history.pushState(null, null, a), n.html(t)), a = 1, a = 2
            },
            error: function(t, o, e) {
