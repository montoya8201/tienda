...
(function (global, factory) {
  ...
  Parsley.addMessages('en', {
    ...
    maxlength: "Este valor es demasiado largo. Debe tener %s characteres o menos.",
    length: "La longitud de este valor no es válida. Debe estar entre %s y %s caracteres.",
